...
pkill -f "$APP/Contents/Helpers/DeskBridgeHelper.app/Contents/MacOS/deskbridge client" >/dev/null 2>&1 || true
sleep 1
...
"$APP/Contents/Helpers/DeskBridgeHelper.app/Contents/MacOS/deskbridge" permissions || true
